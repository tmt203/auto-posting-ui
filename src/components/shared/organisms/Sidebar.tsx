			...
			>
				...
				>
					<div className="flex items-center gap-2">
						...
						>
							<h1 className="text-nowrap font-medium">AUTO POSTING SYSTEM</h1>
							<span className="text-nowrap text-xs font-normal italic">tranminhtri.vercel.app</span>
						</div>
					</div>
				...
				>
					<ProfileDropdownMenu sidebarOpen={sidebarOpen} actions={profiles} name="Admin Demo" />
